...
export const CustomToolsTab: React.FC<CustomToolsTabProps> = ({
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white/[0.02] border border-white/5 p-6 rounded-3xl backdrop-blur-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          <button
            ...
            className="bg-cyan-600 hover:bg-cyan-500 text-white px-6 py-3 rounded-2xl font-bold shadow-lg shadow-cyan-500/20 transition-all flex items-center justify-center gap-2 active:scale-95"
          >
          ...
          <button
            ...
            className="bg-red-600 hover:bg-red-500 text-white px-6 py-3 rounded-2xl font-bold shadow-lg shadow-red-500/20 transition-all flex items-center justify-center gap-2 active:scale-95"
          >
            <Plus className="w-5 h-5" />
            SMS Bomber
          </button>
      ...
      {(simDatabases.length === 0 && smsBombers.length === 0) ? (
